...
### 使用方法
在SuWar3Tools里改键设置里右键->脚本->运行扩展程序，然后将11.exe复制到“SuWar3Tools\SuWar3ToolsExt”目录里，选择11.exe程序后会提示输入参数，参数格式为“类型 11账号 11密码”(中间用空格分隔)，其中类型参数为：1:Dota 2:IMBA 3:OMG 4:真三 5:IM起源 6:信长 7:IMCA 8:OMG起源"  
如添加真三天梯查询的示例为：    
