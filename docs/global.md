...
* 平台识别：极少的一点功能会针对特殊平台做调整，默认Auto即可，比如某平台1.20的版本改键不生效时可以在Auto模式下会自动识别平台后修正，也可以手动选择平台，"None"表示关闭平台识别功能
* 小地图友军和敌军颜色：用来设置小地图友军和敌军的颜色，方便区分，左边为友军，右边为敌军，颜色为RGB的十六进制码，可手动输入也可以双击选择颜色，如颜色不生效可尝试切换颜色模式
